...
namespace GemsCraft.AppSystem.Scheduler
{
    ...
    public sealed class SchedulerTask
    {
        ...
        {
            if (interval.Ticks < 0) throw new ArgumentException("Interval must be positive", nameof(interval));
            Interval = interval;
            return RunForever();
        }
        ...
        /// <summary>
        /// Runs the task forever at a given interval after an initial
        /// delay, until manually stopped.
        /// </summary>
        ...
        /// <summary>
        /// Runs the task forever at a given interval after an initial delay,
        ...
        /// <summary>
        /// Runs the task a given number of times, at a given
        /// interval after an initial delay.
        /// </summary>
        public SchedulerTask RunRepeating(TimeSpan delay, TimeSpan interval, int times)
        {
            if (times < 1) throw new ArgumentException("Must be ran at least 1 time.", nameof(times));
            MaxRepeats = times;
            return RunForever(interval, delay);
        }
        ...
        /// <summary>
        /// Runs the task a given number of times, at a given interval after an
        /// initial delay.
        /// </summary>
        ...
        /// <summary>
        /// If you need longer than 100 years I don't know what to tell you :|
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            if (Callback.Method.DeclaringType != null) sb.Append(Callback.Method.DeclaringType.Name);
            sb.Append('.');
