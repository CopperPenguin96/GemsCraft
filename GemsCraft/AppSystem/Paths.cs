...
{
    /// <summary>
    /// Contains GemsCraft path settings, and some file-system things
    /// </summary>
    public static class Paths
    {
        ...
        public const string LogPathDefault = "logs";
        public const string ConfigFileNameDefault = "config.json";
        ...
        /// <summary>
        /// Working path (wherever GemsCraft.dll is)
        /// </summary>
        ...
        public const string PlayerDBFileName = "PlayerDB.json";
        ...
        {
            if (fileName == null) throw new ArgumentNullException(nameof(fileName));
            return caseSensitive == MonoCompat.IsCaseSensitive ? File.Exists(fileName) : new FileInfo(fileName).Exists(caseSensitive);
        }
        ...
        {
            if (originalFullFileName == null) throw new ArgumentNullException(nameof(originalFullFileName));
